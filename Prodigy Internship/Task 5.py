...
# File path to the original big CSV file
file_path = 'G:/internship 2/Task 5/US_Accidents_March23.csv'

# Taking the sampling fraction  4%
sampling_fraction = 0.04  # Reducing sample size to approximately 4%

# Loading the dataset in chunks and samplimg from each chunk to overcome large size issue of dataset
chunksize = 50000  # Number of rows per chunk
sampled_data = []

# Looping through the file in chunks
...
output_file_path = 'G:/internship 2/Task 5/reduced_US_Accidents_March23.csv'
df_sampled.to_csv(output_file_path, index=False)

# Checking the size of the reduced dataset
reduced_file_size = os.path.getsize(output_file_path) / (1024 * 1024)  # Size in MB
print(f'Reduced file size: {reduced_file_size:.2f} MB')
...
file_path = 'G:/internship 2/Task 5/reduced_US_Accidents_March23.csv'
